...
(function() {
  var GeoHashRegion, LatLon, NearestRegionFinder, PhraseSignature, TFIDF, TweetCountsFactory, app, csv, expandSummary, express, geohash, ngramLength, port, regionFinder, tfidf, thisPackage, tweetCounts, _;
  ...
  app.get('/archive/archive.csv', function(req, resp) {
    var _this = this;
    csv = [];
    csv.push(["region", "nGram", "tweets"]);
    return tweetCounts.dumpToArchive(function(archive) {
      var entry, _i, _len;
