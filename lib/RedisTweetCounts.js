...
(function() {
  ...
  RedisTweetCounts = (function() {
    ...
    function RedisTweetCounts(redis, precision, graphite) {
      var _this = this;
      this.redis = redis;
    ...
    RedisTweetCounts.prototype.add = function(latLon, text) {
      var latLonId, nGram, nGramId, _i, _len, _ref;
