...
(function() {
  ...
  EvaluateFromStream = (function(_super) {
    ...
    function EvaluateFromStream(baseURL, twitter, restartAfterSeconds) {
      ...
      this.start = function() {
        return EvaluateFromStream.prototype.start.apply(_this, arguments);
      };
    ...
    EvaluateFromStream.prototype.start = function() {
      EvaluateFromStream.__super__.start.apply(this, arguments);
      this.dumpStats();
      return setInterval(this.dumpStats, 10 * 1000);
    };
